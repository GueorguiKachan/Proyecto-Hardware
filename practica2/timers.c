...
void temporizador_iniciar(void){
 ...
 // T1CTCR = 0x0; // Selecciona modo contador, que cuenta al llegar un flanco ascendente del PCLK
  ...
  T1PR = 0xFFFFFFFE; // Cuando el Prescale Counter Register incremente en 1, el Time Counter también lo hará
  T1MR0 = 0xFFFFFFFE; // Con esto creo que salta una interrupción cuando el TC sea igual a 1, que ocurrirá cada micro //antes estaba a 0
  T1MCR = 3;
...
void temporizador_periodico (int periodo) {
    ...
    T0MR0 = (15000*periodo)-1;                        // Interrumpe cada 1ms = 15.000-1 counts
    //T0MR0 = 14999;
