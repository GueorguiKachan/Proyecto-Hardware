...
void temporizador_iniciar(){
  // VPBDIV_Val = 0x1 --> Esto creo que hace que el PCLK sea el mismo que el CCLK, así el reloj del contador va más rápido. Sección 3.12 del manual LPC
  ...
  T1MR0 = 1; // Con esto creo que salta una interrupción cuando el TC sea igual a 1, que ocurrirá cada micro 
